    ...
    html: `
      <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; color: #1c1917;">
        ...
        <div style="background: #fffbeb; border: 1px solid #fde68a; border-top: none; padding: 24px 32px; border-radius: 0 0 12px 12px;">
          ...
          <p style="font-size: 14px; line-height: 1.6; margin: 0 0 16px;">
            Please review the attached PDF for your full itinerary, flight details, and booking terms. If you have any questions, please reply to this email or WhatsApp us at <strong>+975 77 319 405</strong> or <strong>+61 435 341 033</strong>.
          </p>
