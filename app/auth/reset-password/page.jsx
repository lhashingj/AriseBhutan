    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white p-6">
        <div className="text-center space-y-4">
          ...
          <h1 className="text-2xl font-serif font-bold text-stone-900">Password updated!</h1>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white p-6">
      <div className="w-full max-w-md space-y-7">
        <div>
          <h1 className="text-2xl font-serif font-bold text-stone-900">Set new password</h1>
