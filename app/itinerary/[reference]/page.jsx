                          ...
                          <tr key={i} className={`page-break-avoid ${i % 2 === 0 ? 'bg-white' : 'bg-stone-50'}`}>
                            <td className="px-3 py-2.5 border border-stone-100">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="font-semibold text-stone-800">{ti.name}</span>
                              </div>
                            </td>
                            <td className="px-3 py-2.5 border border-stone-100">
                              <span className="inline-block text-[9px] font-bold px-2 py-0.5 rounded-full bg-stone-100 text-stone-600">
                                {ti.category || '—'}
                              </span>
                            </td>
                            <td className="px-3 py-2.5 text-right border border-stone-100">
                              <span className={`font-bold text-[11px] ${isFree ? 'text-green-600' : 'text-amber-700'}`}>
