        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-black/25 backdrop-blur-sm rounded-2xl p-3 flex flex-col sm:flex-row gap-3">
            <select
              ...
              className="flex-1 bg-white/10 hover:bg-white/15 focus:bg-white/15 text-white rounded-xl px-4 py-3 text-sm outline-none transition-colors [&>option]:text-stone-900"
            >
              {sectors.map(s => (
