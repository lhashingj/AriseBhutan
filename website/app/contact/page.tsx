...
const contactInfo = [
  ...
  { icon: MapPin,        label: 'Office',             value: 'Paro Town, Bhutan',         href: '#' },
    ...
    <div className="pt-18">
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-4">
          <span className="text-amber-400 font-semibold text-sm tracking-widest uppercase mb-4 block">Contact Us</span>
          <h1 className="font-serif text-4xl md:text-5xl font-bold mb-5">Let&apos;s Plan Your Bhutan Journey</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-3xl shadow-lg border border-stone-100 p-8 md:p-10">
                <div className="mb-8">
      ...
      <section className="py-12 bg-stone-900">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-stone-400 text-sm mb-6 tracking-widest uppercase font-medium">Trusted by travelers from</p>
          <div className="flex flex-wrap justify-center gap-6 text-white font-semibold text-lg opacity-70">
