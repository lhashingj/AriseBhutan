    ...
    <footer className="bg-stone-900 text-stone-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <p className="text-xs tracking-widest uppercase text-stone-400">Tours & Travel</p>
              </div>
            </div>
            ...
            <p className="text-xs text-stone-500 mb-3">Licensed by ATCB (Bhutan)</p>
            <div className="flex gap-3">
              <a href="#" aria-label="Facebook" className="w-9 h-9 rounded-full bg-stone-800 hover:bg-amber-600 flex items-center justify-center transition-colors">
                <Facebook className="w-4 h-4" />
              </a>
              <a href="#" aria-label="Instagram" className="w-9 h-9 rounded-full bg-stone-800 hover:bg-amber-600 flex items-center justify-center transition-colors">
                <Instagram className="w-4 h-4" />
              </a>
              <a href="#" aria-label="YouTube" className="w-9 h-9 rounded-full bg-stone-800 hover:bg-amber-600 flex items-center justify-center transition-colors">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-semibold text-white mb-5 text-sm tracking-wider uppercase">Popular Tours</h3>
          ...
          {/* Company */}
          <div>
            <h3 className="font-semibold text-white mb-5 text-sm tracking-wider uppercase">Company</h3>
            <ul className="space-y-3">
              {[
          ...
          {/* Contact */}
          <div>
            <h3 className="font-semibold text-white mb-5 text-sm tracking-wider uppercase">Contact Us</h3>
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="mailto:info@arisebhutan.com" className="text-sm text-stone-400 hover:text-amber-400 transition-colors">
                  info@arisebhutan.com
                </a>
              </div>
            </div>
            ...
            <div className="mt-8">
              ...
              <form className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 bg-stone-800 border border-stone-700 rounded-lg text-sm text-white placeholder-stone-500 focus:outline-none focus:border-amber-500"
                />
                <button
                  type="submit"
